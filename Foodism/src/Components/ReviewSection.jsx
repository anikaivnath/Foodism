  ...
  return (
    ...
    <div>
      <div className='  w-[600px] mt-[210px] ml-20 text-justify '>
        ...
        <p className='mt-4 bg-green-700 text-center text-white p-2 min-w-max m-auto w-40 rounded-lg shadow-lg cursor-pointer  shadow-green-700 hover:bg-green-800'>Customer Feedback</p>
      </div>
    </div>
    </div>
  )
