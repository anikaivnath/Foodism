...
const journey = () => {
  return (
    <div className='flex'>
      ...
      <div>
         <div className='w-[180px] justify-center text-green-600 shadow-lg shadow-black p-2 rounded-40px'>
        ...
        <p className='pl-2 text-center'>Delight your guests with our flavors and presentation</p>
      </div>
      </div>
