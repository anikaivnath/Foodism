...
const HeroSection = () => {
  return (
    ...
    <p className="text-xs text-red-500 font-bold">Hot Spicy Food 🌶️</p>
  </div>


        <div className='absolute bottom-[-12px] flex gap-12'>
        ...
        <p className='pb-2 text-sm text-center'> <span className='text-red-800'>$</span>2.00</p>
